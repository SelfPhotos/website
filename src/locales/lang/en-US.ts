  ...
  message: {
      ...
      privacy: {
        ...
        arr: {
          ...
          7: {
            title: "Contact Us",
            content:
              "If you have any questions or concerns about this Privacy Policy, please contact us at: <a href='{discord}' target='_blank'>Discord</a>",
          },
        },
      },
    },
    home: {
      ...
      section: {
        timeline: {
          title: "Timeline",
          subtitle: "Timeline View – Quickly Locate Your Memories",
          content:
        ...
        folders: {
          title: "Folders",
          subtitle: "Keep Media Organized as It is",
          content:
            "Your photos and videos are displayed in the same structure as on your computer. Stay organized and find files easily.",
        },
        watchMode: {
          title: "Watch Mode",
          subtitle: "Watch Mode – Seamless Updates for Your Media Library",
          content:
            "Keep an eye on your selected folder and instantly adds or removes photos and videos from your library as they appear or disappear. Effortless updates, no manual work needed!",
        },
        privacy: {
          title: "Privacy",
